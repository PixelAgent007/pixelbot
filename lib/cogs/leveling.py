...
class LevelingCog(commands.Cog):
    ...
    async def update_data(self, user: discord.Member):
    ...
    async def add_experience(self, ctx, user: discord.Member):
        ...
        if newxp == xp:
            ...
            embed = Embed(title="Level Up!", color=Colour(0x71368a),
                          description=f"{user.mention} reached Level {lvl:,}, GG!")
    ...
    @cog_ext.cog_slash(name="rank",
                       description="Shows your level. If another member is specified as the first arg, his is shown",
                       options=[
                           create_option(
                               name="member",
